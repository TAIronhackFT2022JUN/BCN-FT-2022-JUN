...
const startGameDivToHide = document.getElementById("gameStarted");
...
if (startGameButton) {
  startGameButton.addEventListener("click", (event) => {
    ...
    startGameDivToHide.classList.add("hidden");
      ...
      if (hangman.checkClickedLetters(letterToPassAsLetter)) {
        ...
        if (hangman.secretWord.includes(letterToPassAsLetter)) {
          ...
          for (let i = 0; i < hangman.secretWord.length; i++) {
            if (hangman.secretWord[i] === letterToPassAsLetter)
