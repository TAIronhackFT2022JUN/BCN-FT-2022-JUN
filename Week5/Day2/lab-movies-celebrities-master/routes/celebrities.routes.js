...
router.post("/celebrities/create", (req, res) => {
  ...
  */
  Celebrity.create({ name, occupation, catchPhrase })
    ...
    .catch((error) =>
      console.log("Error while creating a new celebrity POST ->", error)
    );
});
// --------------------------------------------
...
router.get("/celebrities", (req, res) => {
  Celebrity.find()
    ...
    .catch((err) =>
      console.log("Error while showing all the celebrities GET ->", err)
    );
});
// --------------------------------------------
...
router.post("/celebrities/:id/delete", (req, res, next) => {
  ...
  Celebrity.findByIdAndDelete(id)
    ...
    .catch((error) =>
      console.log(
        "Error while trying to delete the celebrity POST router ->",
        error
      )
    );
});
...
router.get("/celebrities/:id/edit", (req, res, next) => {
  ...
  Promise.all([celebrities])
    .then(([celebrities]) =>
      res.render("celebrities/edit-celebrity.hbs", { celebrities })
    )
    .catch((err) =>
      console.log(
        "Error while trying to show the celebrity info GET router ->",
        err
      )
    );
